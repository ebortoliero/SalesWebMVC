...
namespace SalesWebMVC.Data
{
    public class SeedingService
    {
        ...
        public void Seed()
        {
            ...
            Seller s2 = new Seller(2, "Maria Green", "mariagmail.com", new DateTime(1979, 12, 31), 35000.0, d2);
            Seller s3 = new Seller(3, "Alex Grey", "alexgmail.com", new DateTime(1988, 1, 15), 2200.0, d1);
            Seller s4 = new Seller(4, "Martha Red", "marthagmail.com", new DateTime(1993, 11, 30), 3000.0, d4);
            Seller s5 = new Seller(5, "Donald Blue", "donaldgmail.com", new DateTime(2000, 1, 9), 4000.0, d3);
            Seller s6 = new Seller(6, "ALex Pink", "alexgmail.com", new DateTime(1997, 3, 4), 3000.0, d2);
